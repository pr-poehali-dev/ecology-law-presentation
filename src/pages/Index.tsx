...
const slides: Slide[] = [
  ...
  },
  {
    ...
    content: [
      'Конституция РФ (1993) — высший источник, закрепляет право на благоприятную окружающую среду (ст. 42), обязанность охраны природы (ст. 58)',
      'Федеральный закон №7-ФЗ "Об охране окружающей среды" (2002) — базовый закон, определяющий правовые основы государственной политики в области охраны природы',
      'Специальные федеральные законы: "Об охране атмосферного воздуха", "Об экологической экспертизе", "О животном мире", "Об особо охраняемых природных территориях"',
      'Кодифицированные акты: Земельный кодекс РФ, Водный кодекс РФ, Лесной кодекс РФ, Градостроительный кодекс РФ',
      'Указы Президента РФ и постановления Правительства РФ (например, о государственных программах охраны окружающей среды)',
      'Международные договоры РФ: Конвенция о биологическом разнообразии, Киотский протокол, Парижское соглашение по климату',
  ...
  },
  {
    ...
    content: [
      'ФЗ-7 "Об охране окружающей среды" (2002) — устанавливает правовые основы государственной политики, принципы охраны природы, права и обязанности граждан и организаций',
      'ФЗ-96 "Об охране атмосферного воздуха" (1999) — регулирует отношения по предотвращению и снижению вредных воздействий на атмосферу, устанавливает нормативы выбросов',
      'Водный кодекс РФ (2006) — определяет порядок использования водных объектов, охрану водных ресурсов, водоохранные зоны',
      'Лесной кодекс РФ (2006) — регулирует лесные отношения, устанавливает виды использования лесов, меры по их охране и защите',
      'ФЗ-52 "О животном мире" (1995) — устанавливает правовой режим охраны и использования объектов животного мира и среды их обитания',
      'ФЗ-174 "Об экологической экспертизе" (1995) — закрепляет обязательность проведения государственной экологической экспертизы для определённых видов деятельности',
      'ФЗ-33 "Об особо охраняемых природных территориях" (1995) — устанавливает категории ООПТ (заповедники, национальные парки, заказники)',
      'ФЗ-89 "Об отходах производства и потребления" (1998) — регулирует обращение с отходами всех классов опасности'
    ],
    image: 'https://cdn.poehali.dev/projects/f54f90fb-f631-4b4c-8d3c-81cb244567ef/files/b3252498-16e6-4289-8b3b-1ca75c32d5d5.jpg'
  },
  {
